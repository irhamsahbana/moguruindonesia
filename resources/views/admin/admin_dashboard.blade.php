...
<div class="row">
  ...
  <div class="col-md-6 col-lg-3">
    <div class="card card-body">
      <h6>
        <span class="text-uppercase">Total Tutor</span>
        <span class="float-right"><a class="btn btn-xs btn-primary" href="#">View</a></span>
      </h6>
      <br>
      <p class="fs-28 fw-100">100</p>
      <div class="progress">
  ...
  <div class="col-md-6 col-lg-3">
    <div class="card card-body">
      <h6>
        <span class="text-uppercase">Pemasukan</span>
        <span class="float-right"><a class="btn btn-xs btn-primary" href="#">View</a></span>
      </h6>
      <br>
      <p class="fs-28 fw-100">Rp. 20.000.000</p>
      <div class="progress">
        <!-- <div class="progress-bar bg-danger" role="progressbar" style="width: 65%; height: 4px;" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100"></div> -->
      </div>
      <div class="text-gray fs-12"><i class="ti-stats-down text-danger mr-1"></i> %32 down from last month</div>
  ...
  <div class="col-lg-6">
    <div class="card">
      <div class="card-header">
        ...
        <div class="dropdown bootstrap-select form-control form-control-sm" style="width: 140px;"><select class="form-control form-control-sm" data-provide="selectpicker" data-width="140" tabindex="-98">
          <option>Today</option>
          <option>Yesterday</option>
          <option>Last week</option>
          <option>Last month</option>
        </select><button type="button" class="btn dropdown-toggle btn-light" data-toggle="dropdown" role="button" title="Today"><div class="filter-option"><div class="filter-option-inner"><div class="filter-option-inner-inner">Today</div></div> </div></button><div class="dropdown-menu " role="combobox"><div class="inner show" role="listbox" aria-expanded="false" tabindex="-1"><ul class="dropdown-menu inner show"></ul></div></div></div>
      </div>
